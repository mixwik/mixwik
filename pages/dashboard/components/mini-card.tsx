...
export const MiniCard = ({ borderColor, position, bg }: {borderColor:string, position:string, bg:string}) => {
  return (
    <div className={`absolute ${borderColor} ${position} flex flex-col items-center justify-center w-10 h-16 gap-1 p-1 border border-solid rounded-lg shadow-lg md:h-20 md:w-14 bg-white`}>
