      ...
      <section className='flex items-center justify-center bg-white'>
        <div className='container flex items-center justify-center px-6 py-12 mx-auto h-[90vh]'>
          <div className='flex flex-col items-center max-w-sm mx-auto text-center'>
            ...
            <h1 className='mt-3 text-2xl font-semibold text-gray-800 md:text-3xl'>No puedes acceder a este contenido</h1>
            <p className='mt-4 text-gray-500'>Si quieres ver las publicaciones de los usuarios debes de estar registrado en MixWik.com</p>
