...
const User = () => {
  ...
  const currentCsgo = useGetOnePublication('fortnite', id)
  ...
  const handleUpdatePosition = () => {
    updatePublicationPosition('fortnite', id, currentPosition)
  }
  ...
  const handleDelete = () => {
    if (window.confirm(`¿Eliminar la publicación de ${currentUser.name}?`)) {
      deletePublication('fortnite', id, currentUser.id, 'fortnite')
      ...
      <div className={styles.user}>
        ...
        <section className={styles.userBox}>
          ...
          <div className={styles.publicationTitle}>
            {
              edit === 'title'
                ? (
                  <EditTitle category='fortnite' id={id} title={currentCsgo.title} setEdit={setEdit} />
                  )
                : (
                  <h1>
                    {currentCsgo.title}
          ...
          <article className={styles.typeOfGamer}>
            ...
            edit === 'typeOfGamer'
              ? (
                <EditTypeOfGamer category='fortnite' id={id} typeOfGamer={currentCsgo.typeOfGamer} setEdit={setEdit} />
                )
              : (
                <>
                  <h2>Tipo de jugador:
          ...
          <article className={styles.preferenceTeam}>
            {
              edit === 'preferenceTeam'
                ? (
                  <EditPreferenceTeam category='fortnite' id={id} preferenceTeam={currentCsgo.preferenceTeam} setEdit={setEdit} />
                  )
                : (
                  <>
                    <h2>
          ...
          <article className={styles.position}>
            {
              edit === 'position'
                ? (
                  <EditPosition category='fortnite' id={id} position={currentCsgo.position} setEdit={setEdit} />
                  )
                : (
                  <>
                    <h2>
          ...
          <article className={styles.hours}>
            {
              edit === 'hours'
                ? (
                  <EditHours category='fortnite' id={id} hours={currentCsgo.hours} setEdit={setEdit} />
                  )
                : (
                  <>
                    <h2>
