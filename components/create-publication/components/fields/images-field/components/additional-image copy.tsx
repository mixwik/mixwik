...
export const AdditionalImage = ({ handleSetImage, previewImage, handleRemoveImage, imgURL, setPreviewImage, setImgURL, setImage, image }) => {
  return (
    <label className='flex items-center justify-center bg-gray-100 border-2 border-solid rounded-md shadow-lg size-24 shadow-gray-300 border-aero'>
      <input
        className='hidden'
