export const AddPublication = ({ className }) => {
  return (
    <svg width='16' height='16' fill='currentColor' className={className} viewBox='0 0 16 16'>
...
export const PublicationsIcon = () => {
  return (
    <svg width='16' height='16' fill='currentColor' className='bi bi-file-earmark' viewBox='0 0 16 16'>
      <path d='M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z' />
    </svg>
  )
}
...
export const FavIcon = ({ className }) => {
  return (
    <svg className={className} width='44' height='44' viewBox='0 0 24 24' strokeWidth='1.5' stroke='#000000' fill='none' strokeLinecap='round' strokeLinejoin='round'>
      <path stroke='none' d='M0 0h24v24H0z' fill='none' />
      <path d='M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572' />
    </svg>
  )
}
export const FavSelectedIcon = ({ className }) => {
  return (
    <svg className={className} width='44' height='44' viewBox='0 0 24 24' strokeWidth='1.5' stroke='#000000' fill='none' strokeLinecap='round' strokeLinejoin='round'>
      <path stroke='none' d='M0 0h24v24H0z' fill='none' />
...
export const UserIcon = () => {
  return (
    <svg width='16' height='16' fill='currentColor' className='bi bi-person-circle' viewBox='0 0 16 16'>
...
export const RangeAge = () => {
  return (
    <svg width='16' height='16' fill='currentColor' className='bi bi-calendar4-range' viewBox='0 0 16 16'>
...
export const GamePosition = ({ className }) => {
  return (
    <svg width='16' height='16' fill='currentColor' className={className} viewBox='0 0 16 16'>
...
export const GameLevel = ({ className }) => {
  return (
    <svg width='16' height='16' fill='currentColor' className={className} viewBox='0 0 16 16'>
...
export const GamerType = ({ className }) => {
  return (
    <svg width='16' height='16' fill='currentColor' className={className} viewBox='0 0 16 16'>
...
export const FilterCancelIcon = ({ className }) => {
  return (
    <svg className={className} width='44' height='44' viewBox='0 0 24 24' strokeWidth='1.5' stroke='#000000' fill='none' strokeLinecap='round' strokeLinejoin='round'>
      <path stroke='none' d='M0 0h24v24H0z' fill='none' />
...
export const Arrow = () => {
  return (
    <svg width='16' height='16' fill='currentColor' className='bi bi-caret-right' viewBox='0 0 16 16'>
...
export const CheckIcon = () => {
  return (
    <svg width='16' height='16' fill='currentColor' className='bi bi-check-circle' viewBox='0 0 16 16'>
...
export const WhatsAppIcon = () => {
  return (
    <svg width='16' height='16' fill='currentColor' className='bi bi-whatsapp' viewBox='0 0 16 16'>
...
export const DiscordIcon = ({ className }) => {
  return (
    <svg viewBox='0 0 256 199' width='256' height='199' preserveAspectRatio='xMidYMid' className={className}>
...
export const TwitterIcon = ({ className }) => {
  return (
    <svg width='1200' height='1227' fill='none' viewBox='0 0 1200 1227' className={className}>
...
export const BugsIcon = ({ className }) => {
  return (
    <svg width='16' height='16' fill='currentColor' className={className} viewBox='0 0 16 16'>
