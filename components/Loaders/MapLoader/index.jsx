...
const MapLoader = () => {
  return (
    <div className='relative w-full md:w-[50vw] h-[50vh] md:h-[90vh] bg-gray-300 flex flex-col gap-5 justify-center items-center'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <span className='z-10 text-xl font-bold'>Cargando...</span>
      </div>
    </div>
  )
}
